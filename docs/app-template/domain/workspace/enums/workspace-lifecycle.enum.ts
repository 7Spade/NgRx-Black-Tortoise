/**
 * ============================================================
 * 檔案名稱： workspace-lifecycle.enum.ts
 * 功能說明： 負責Enum定義與共用行為，支援 domain/workspace/enums 相關流程。
 * 所屬模組： domain/workspace/enums
 * ============================================================
 *
 * 【業務背景 / 使用情境】
 ...
 * Controls visibility, access, and available operations.
 */
export enum WorkspaceLifecycle {
  /**
   * Active - Workspace is active and fully operational
   * - All features available
   * - Members can access and collaborate
   ...
   * - Not visible in default workspace list
   */
  ARCHIVED = 'ARCHIVED',
   ...
   * - Usually due to policy violations or payment issues
   * - Can be restored after resolving issues
   */
  SUSPENDED = 'SUSPENDED',
   ...
   * - May have grace period for recovery
   */
  DELETED = 'DELETED',
}
