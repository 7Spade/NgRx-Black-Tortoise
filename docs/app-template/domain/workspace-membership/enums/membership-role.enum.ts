 ...
 * MembershipRole Enum
 * 
 * Defines the roles a member can have in a workspace.
 * Determines permissions and capabilities within the workspace.
 */
export enum MembershipRole {
   ...
   * - Can manage billing (for paid workspaces)
   ...
   * - Cannot create new content (unless granted specific permissions)
   * - Typically for external collaborators
   */
  GUEST = 'GUEST',
}
