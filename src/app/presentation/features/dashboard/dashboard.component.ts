        ...
        <div class="cards-grid">
          <mat-card class="dashboard-card">
            <mat-card-header>
              ...
              <mat-card-subtitle>View your performance metrics and insights</mat-card-subtitle>
            </mat-card-header>
          </mat-card>
          ...
          <mat-card class="dashboard-card">
            <mat-card-header>
              ...
              <mat-card-subtitle>Manage and organize your projects</mat-card-subtitle>
            </mat-card-header>
          </mat-card>
          ...
          <mat-card class="dashboard-card">
            <mat-card-header>
              ...
              <mat-card-subtitle>Collaborate with team members</mat-card-subtitle>
            </mat-card-header>
          </mat-card>

          <mat-card class="dashboard-card">
            <mat-card-header>
              <div mat-card-avatar class="card-icon">⚙️</div>
              <mat-card-title>Settings</mat-card-title>
              <mat-card-subtitle>Customize your preferences</mat-card-subtitle>
            </mat-card-header>
          </mat-card>
        </div>
      </main>
